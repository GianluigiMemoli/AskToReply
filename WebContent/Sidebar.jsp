<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
		...
		<div class="sidebar aperta" id="sidebar">
			...
			<a href="Home.jsp" id="home_sidebar_item">
			...
			<a href="Profilo.jsp" id="profilo_sidebar_item">
			...
			<a href="Ricerca.jsp" id="ricerca_sidebar_item">
			...
			<a href="Logout.jsp" id="logout_sidebar_item">
